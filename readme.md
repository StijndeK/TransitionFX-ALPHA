...
## Improvements
TFX is still under development. There are a lot of functionalities to be added. At the moment I am refactoring the code in a [second repository](https://github.com/StijndeK/TransitionFX).
